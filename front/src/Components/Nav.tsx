...
let [view , setview] = useState(false)
    ...
    <div className="fixed top-0 left-0 w-full h-20  items-center px-1 sm:px-6 backdrop-blur-md bg-[rgba(144,144,145,0.2)] z-50 justify-between hidden  sm:flex" >
...
<motion.button className="text-white text-[20px] "
...
{view &&
  <div className="w-full h-[100vh] fixed top-0 left-0 bg-[rgba(188,187,187,0.42)] z-40 flex justify-end" >
    <div className="flex flex-col mt-[80px] w-[50px] backdrop-blur-md bg-[rgba(144,144,145,0.2)] items-center gap-4 ">

      <Link to="/" className="text-white w-[40px] h-[40px] flex items-center justify-center text-[20px]">
        <i className="fa-solid fa-house"></i>
      </Link>

      <Link to="/Movie" className="text-white w-[40px] h-[40px] flex items-center justify-center text-[20px]">
        <i className="fa-solid fa-play"></i>
      </Link>

      <motion.button className="w-[40px] h-[40px] flex items-center justify-center text-white text-[20px]">
        <i className="fa-solid fa-magnifying-glass" style={{ color: "inherit" }}></i>
      </motion.button>

      <motion.button className="w-[40px] h-[40px] flex items-center justify-center text-[20px] text-white">
